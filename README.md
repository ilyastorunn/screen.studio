...
Build with `npm run build`. For Cloudflare Pages use `npm run build` as the build command and `dist` as the output directory. The production site is [niceapps.club](https://niceapps.club).
